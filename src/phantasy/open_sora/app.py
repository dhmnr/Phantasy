...
CONFIG_MAP = {
    "v1.2-stage3": "configs/inference/sample.py",
}
...
def main():
    ...
    demo.launch(server_port=args.port, server_name=args.host, share=args.share, max_threads=1, app_kwargs={"docs_url": "/docs"})
